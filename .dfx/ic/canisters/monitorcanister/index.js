...
import { idlFactory } from './monitorcanister.did.js';
export { idlFactory } from './monitorcanister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_MONITORCANISTER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./monitorcanister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the monitorcanister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./monitorcanister.did.js")._SERVICE>}
 */
export const monitorcanister = createActor(canisterId);
